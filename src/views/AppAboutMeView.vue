<template>
  <section id="AppAboutMe" class="AppAboutMe">
    ...
    <p>
      Aujourd'hui, je construis ce nouveau chapitre de ma vie avec la même détermination et la même rigueur que dans mon ancienne carrière. J'ai troqué le soin des patients pour la création de solutions numériques, mais mon désir de faire la différence reste intact. Ce portfolio est une invitation à découvrir ce qui me motive, ce qui me passionne et comment je mets tout mon cœur dans ce que je fais en tant que développeuse web.
    </p>
    <p>
